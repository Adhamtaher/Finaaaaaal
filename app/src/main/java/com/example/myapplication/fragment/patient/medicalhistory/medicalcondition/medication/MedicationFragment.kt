package com.example.myapplication.fragment.patient.medicalhistory.medicalcondition.medication
...
@AndroidEntryPoint
class MedicationFragment : Fragment(),RadiationHistoryAdapter.OnItemClickListener {
    ...
    override fun onCreateView(
        ...
        binding.btnAdd.setOnClickListener {
            val action=MedicationFragmentDirections.actionMedicationFragmentToMedicalRecordAddFragment(binding.txtTitle.text.toString())
    ...
    override fun onItemClick(position: Int) {
        val action= MedicationFragmentDirections.actionMedicationFragmentToSurgeriesResults(binding.txtTitle.text.toString() ,adapter.currentList[position].id.toString())
        findNavController().navigate(action)
    }
