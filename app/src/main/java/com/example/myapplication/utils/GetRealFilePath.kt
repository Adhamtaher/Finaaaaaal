...
import com.example.myapplication.fragment.patient.medicalhistory.medicalcondition.MedicalRecordAddViewModel
import java.io.*
import java.util.*


internal fun getFilePathFromUri(context: Context, uri: Uri,signUpViewModel: MedicalRecordAddViewModel): String? =
...
private fun getFileFromContentUri(context: Context, contentUri: Uri, signUpViewModel: MedicalRecordAddViewModel): File {
